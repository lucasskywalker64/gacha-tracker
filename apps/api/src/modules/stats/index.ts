  ...
  .get(
    ...
    async ({ params, user }) => {
      ...
      const stats = {
        ...
        fiveStarHistory: [] as { id: string, itemId: string, itemName: string, pityAtPull: number, wasGuaranteed: number, pulledAt: number, bannerType: string }[], // Explicitly typed array of recent 5 stars
      };
